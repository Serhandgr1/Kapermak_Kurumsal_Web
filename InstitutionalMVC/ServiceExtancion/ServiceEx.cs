...
namespace InstitutionalMVC.ServiceExtancion
{
    public static class ServiceEx
    {
        ...
        //{
        //    services.AddDbContext<DataContext>(options => options.UseSqlServer(configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("InstitutionalMVC")));
        //}
